...
namespace RedMood.Specs
{
    ...
    public partial class RegisterAHappyMoodFeature
    {
        ...
        public virtual void RegisterAHappySmileyClick()
        {
            ...
            testRunner.And("the counter for the happy smiley is currently at 2", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
            testRunner.When("I press the happy smiley icon", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("the happy smiley counter shown on the web page should be 3", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
